...
<div class="w-full max-w-md text-center">
    <div class="bg-white rounded-lg shadow-2xl p-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mt-4">Sedang Logout...</h1>
            <p class="text-gray-600 text-sm mt-2">Terima kasih telah menggunakan aplikasi kami</p>
        </div>
        
        <!-- Progress Bar -->
        <div class="mt-8 bg-gray-200 rounded-full h-2 overflow-hidden">
            <div class="bg-gradient-to-r from-red-500 to-pink-500 h-full animate-pulse" style="width: 100%;"></div>
        </div>
        
        <p class="text-gray-500 text-xs mt-4">Anda akan dialihkan dalam beberapa detik...</p>
    </div>
</div>
