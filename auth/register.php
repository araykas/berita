...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-lg shadow-2xl p-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Bergabunglah dengan komunitas kami</p>
        </div>
        ...
        <form method="post" id="registerForm" class="space-y-5">
            ...
            <button 
                type="submit" 
                class="w-full bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 text-white font-semibold py-2.5 rounded-lg transition-all duration-200 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
                id="submitBtn"
            >
